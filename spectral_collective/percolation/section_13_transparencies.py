...
class FadedSlow(Scene):
    def construct(self):
        ...
        self.play(p.animate.set_value(1), run_time=30, rate_func=rate_functions.linear)
        self.play(p.animate.set_value(0), run_time=30, rate_func=rate_functions.linear)
        self.play(p.animate.set_value(1), run_time=30, rate_func=rate_functions.linear)
        self.play(p.animate.set_value(0), run_time=30, rate_func=rate_functions.linear)
